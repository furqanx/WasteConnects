                ...
                <div class="carousel-item" style="background-image: url({{ asset('img/carousel-2.jpeg') }})">
                    <div class="carousel-container">
                        <div class="container">
                            ...
                            <p class="animate_animated animate_fadeInUp">Cari dan temukan jenis sampah yang Anda
                                butuhkan.
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
                        ...
                        <p class="fst-italic">
                            ...
                            Dengan platform inovatif kami, kami menghubungkan mereka yang memiliki sampah dengan mereka
                            yang
                            mencarinya untuk keperluan mereka sendiri. Tujuan kami adalah menciptakan lingkungan yang
                            lebih
                        ...
                        <p>
                            ...
                            Kami ingin menciptakan platform yang memudahkan individu dan bisnis dalam mencari,
                            memperoleh,
                            dan memanfaatkan
                            sampah dengan cara yang bertanggung jawab. Dengan demikian, kami berharap dapat
                            berkontribusi
                            pada penurunan
                        ...
                        <p>
                            ...
                            butuhkan atau ingin tawarkan. Kami berkomitmen untuk memberikan pengalaman yang aman,
                            nyaman,
                            dan andal bagi
                            pengguna kami. Kami juga bertujuan untuk meningkatkan kesadaran akan pentingnya daur ulang
                            dan
                            mengurangi dampak
                        ...
                        <div class="icon-box iconbox-blue">
                            <div class="icon mb-5">
                                <svg width="100" height="100" viewBox="0 0 600 600"
                                    ...
                                    <img src="{{ asset('img/logo-1.jpeg') }}" width="120" height="120">
                                </svg>
                                <i class="bx bxl-dribbble"></i>
                            </div>
                            <h4>Cari Sampah yang Dibutuhkan</h4>
                            <p>Temukan jenis sampah yang Anda butuhkan dengan mudah melalui aplikasi WasteConnect.
                                Cari kertas, plastik, logam, dan banyak lagi untuk mendukung kebutuhan Anda.</p>
                        </div>
                    </div>
                        ...
                        <div class="icon-box iconbox-orange ">
                            <div class="icon mb-5">
                                <svg width="100" height="100" viewBox="0 0 600 600"
                                    ...
                                    <img src="{{ asset('img/logo-5.jpeg') }}" width="120" height="120">
                                </svg>
                                <i class="bx bx-file"></i>
                            </div>
                            <h4><a href="">Upload Sampah Anda</a></h4>
                            <p>Tawarkan sampah yang Anda miliki dengan cepat dan mudah melalui WasteConnect. Unggah foto
                                dan deskripsi sampah Anda untuk mempertemukan dengan pengguna yang membutuhkannya.</p>
                        </div>
                    </div>
                        ...
                        <div class="icon-box iconbox-pink">
                            <div class="icon mb-5">
                                <svg width="100" height="100" viewBox="0 0 600 600"
                                    ...
                                    <img src="{{ asset('img/logo-4.jpeg') }}" width="120" height="120">
                                </svg>
                                <i class="bx bx-tachometer"></i>
                            </div>
                            <h4><a href="">Koneksi Langsung antara Pengguna</a></h4>
                            <p>Terhubung langsung dengan pengguna lain melalui aplikasi WasteConnect. Jalin kontak,
                                negosiasi,
                                dan transaksi dengan mudah untuk memanfaatkan sampah yang Anda cari atau tawarkan.</p>
                        </div>
                    </div>
                        ...
                        <div class="icon-box iconbox-yellow">
                            <div class="icon mb-5">
                                <svg width="100" height="100" viewBox="0 0 600 600"
                                    ...
                                    <img src="{{ asset('img/logo-3.jpeg') }}" width="120" height="120">
                                </svg>
                                <i class="bx bx-layer"></i>
                            </div>
                            <h4><a href="">Pencocokan Otomatis</a></h4>
                            <p>Nikmati kemudahan pencocokan otomatis dalam WasteConnect. Aplikasi kami akan memadankan
                                pengguna
                                yang mencari sampah dengan pengguna yang menawarkannya.</p>
                        </div>
                    </div>
                        ...
                        <div class="icon-box iconbox-red">
                            <div class="icon mb-5">
                                <svg width="100" height="100" viewBox="0 0 600 600"
                                    ...
                                    <img src="{{ asset('img/logo-2.jpeg') }}" width="120" height="120">
                                </svg>
                                <i class="bx bx-slideshow"></i>
                            </div>
                            <h4><a href="">Informasi Detail Sampah</a></h4>
                            <p>Dapatkan informasi detail tentang sampah yang tersedia melalui WasteConnect. Ketahui
                                kategori,
                                berat, kondisi, dan informasi penting lainnya untuk memastikan kecocokan dengan
                                kebutuhan
                                Anda sebelum
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member">
                            <img src="{{ asset('img/img-furqan-2.JPG') }}" alt="">
                            <h4>Furqan Al Ghifari Zulva</h4>
                            <span>Students</span>
                            <p>
                                Mewujudkan Ide menjadi Realitas Digital
                            </p>
                            {{-- <div class="social">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member">
                            <img src="{{ asset('img/img-malik-2.jpeg') }}" alt="">
                            <h4>T Malik Kamal</h4>
                            <span>Students</span>
                            <p>
                                Menciptakan Pengalaman Pengguna yang Ramah
                            </p>
                            {{-- <div class="social">
                            <a href=""><i class="bi bi-twitter"></i></a>
                            <a href=""><i class="bi bi-facebook"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member">
                            <img src="{{ asset('img/img-hafidz-2.jpeg') }}" alt="">
                            <h4>M Hafidz Zuliesky</h4>
                            <span>Students</span>
                            <p>
                                Membangun Komunitas Online dengan Satu Klik
                            </p>
                            <div class="social">
                                <a href=""><i class="bi bi-twitter"></i></a>
                                <a href=""><i class="bi bi-facebook"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member">
                            <img src="{{ asset('img/img-rifa.jpeg') }}" alt="">
                            <h4>Rifa Faruqi</h4>
                            <span>Students</span>
                            <p>
                                Menganyam Cerita Digital dengan Desain
                            </p>
                            <div class="social">
                                <a href=""><i class="bi bi-twitter"></i></a>
                                <a href=""><i class="bi bi-facebook"></i></a>
